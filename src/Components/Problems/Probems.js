...
function Probems() {
  return (
    <>
      <h1 className=" px-6 mt-[64px] max-w-[1440px] m-auto font-Montserrat font-bold not-italic text-[32px] text-[#164EC0] ">Relations and Functions ( Mathematics )</h1>
      <ul className="mt-[84px] max-w-[1440px] m-auto flex items-center justify-center gap-10 text-[#696671] font-Inter font-medium not-italic text-xl ">
        <li className="text-[#06286E] border-b-2 border-[#06286E] pb-3 font-Inter font-bold">Study </li>
        <li className="pb-3">Quiz </li>
        <li className="pb-3">Test </li>
        <li className="pb-3">Game </li>
        <li className="pb-3">Others</li>
      </ul>
      <div className="w-full flex items-center justify-center flex-col gap-8">
        <p className="w-[712px] h-[393px] rounded-[42px] bg-Gradient1 mt-8 flex items-center justify-center text-white font-Lato font-bold text-[38.257px]">
          9 + 6 + 7x - 2x - 3
        </p>
        <div className="flex items-center justify-center gap-[140px] w-[612px] h-[60px] ">
          <div>
          ...
          <div className="flex items-center justify-center gap-[43px] w-[272px] h-full">
            <div>
            ...
            <p className="text-[#202B37] font-Inter text-2xl font-bold">
              01/10
            </p>
            <div>
              <svg xmlns="http://www.w3.org/2000/svg" width="60" height="61" viewBox="0 0 60 61" fill="none">
